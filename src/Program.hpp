...
class Program {
  private:
    ...
    int xSpeed;                // Speed of the bouncing text in the x axis (horizontal speed)
    int ySpeed;                // Speed of the bouncing text in the y axis (vertical speed)
    ...
    raylib::Font scary;                // Font used for all text
